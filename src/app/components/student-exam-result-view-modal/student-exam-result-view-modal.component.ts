...
@Component({
  selector: 'app-student-exam-result-view-modal',
  templateUrl: './student-exam-result-view-modal.component.html',
  styleUrls: ['./student-exam-result-view-modal.component.scss'],
})
export class StudentExamResultViewModalComponent implements OnInit {
